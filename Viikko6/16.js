...
// 2. Tulosta taulukon tietotyyppi
console.log("\n2. Taulun tietotyyppi:\n", typeof bookArray);

// 3. Tulosta koko taulukko
console.log("\n3. Koko taulukon sisältö:\n", bookArray);

// 4. Tulosta ensimmäinen rivi (indeksi 0)
console.log("\n4. Ensimmäinen rivi taulukosta:\n", bookArray[0]);

// 5. Tulosta ensimmäisen kirjan nimi
console.log("\n5. Ensimmäisen kirjan nimi:\n", bookArray[0].name);

// 6. Tulosta taulukon rivien määrä
console.log("\n6. Taulukon rivien määrä:\n", bookArray.length);
